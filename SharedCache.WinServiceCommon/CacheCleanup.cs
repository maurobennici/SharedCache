...
namespace SharedCache.WinServiceCommon
{
    ...
    public class CacheCleanup
    {
        ...
        private Enums.ServiceCacheCleanUp _cleanupCacheConfiguration = Enums.ServiceCacheCleanUp.CACHEITEMPRIORITY;
        ...
        public Enums.ServiceCacheCleanUp CleanupCacheConfiguration
        {
            ...
            get { return this._cleanupCacheConfiguration; }

            [System.Diagnostics.DebuggerStepThrough]
            set { this._cleanupCacheConfiguration = value; }
        }
        #endregion
        #region Property: CacheAmountOfObjects
        private readonly long _cacheAmountOfObjects = -1;
        ...
        {
            [System.Diagnostics.DebuggerStepThrough]
            get { return this._cacheAmountOfObjects; }
        }
        #endregion
        ...
        {
            [System.Diagnostics.DebuggerStepThrough]
            get { return this._purgeIsRunning; }
        }
        #endregion
        private Dictionary<string, Cleanup> _cleanupDict;
        /// <summary>
        ...
        public Dictionary<string, Cleanup> CleanupDict
        {
            ...
            get
            {
                if (this._cleanupDict == null)
                {
                    this._cleanupDict = new Dictionary<string, Cleanup>();
                }
                return this._cleanupDict;
            }
        }
        ...
        public List<string> Purge(long actualCacheSize)
        {
            ...
            lock (BulkObject)
            {
                ...
                if (this._purgeIsRunning) return null;

                // set the flag to prevent additional threads to access 
                // and to wait for the following lock.
                this._purgeIsRunning = true;
            }

            var removeObjectKeys = new List<string>();
            ...
            lock (BulkObject)
            {
                try
                {
                    ...
                    switch (this._cleanupCacheConfiguration)
                    {
                        #region Sorting
                    ...
                    } while (!((actualCacheSize * this.cacheFillFactor / this._cacheAmountOfObjects) < this.cacheFillFactor));
                }
                finally
                {
                    this._purgeIsRunning = false;
                }
            }
